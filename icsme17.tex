...
\author{\IEEEauthorblockN{Hoan Anh Nguyen$^1$, Tung Thanh Nguyen$^2$, Tien N. Nguyen$^3$, and Hung V. Nguyen$^4$}
\IEEEauthorblockA{Iowa State University, Utah State University, University of Texas at Dallas, Google Corp.\\}}
...
we propose {\tool}, a novel tool for matching program entities across
versions, which mainly relies on their interactions in the code. The
key idea of {\tool} is that the role and functionality of an entity
